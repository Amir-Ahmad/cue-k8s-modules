...
import (
	...
	"github.com/amir-ahmad/cue-k8s-modules/k8s-schema/k8s.io/api/core/v1"
)
...
#HPAScalingRules: {
	...
	// +optional
	tolerance?: null | resource.#Quantity @go(Tolerance,*resource.Quantity) @protobuf(4,bytes,opt)
}
