...
import (
	metav1 "github.com/amir-ahmad/cue-k8s-modules/k8s-schema/k8s.io/apimachinery/pkg/apis/meta/v1"
	"github.com/amir-ahmad/cue-k8s-modules/k8s-schema/k8s.io/apimachinery/pkg/types"
	authenticationv1 "github.com/amir-ahmad/cue-k8s-modules/k8s-schema/k8s.io/api/authentication/v1"
	"github.com/amir-ahmad/cue-k8s-modules/k8s-schema/k8s.io/apimachinery/pkg/runtime"
)
