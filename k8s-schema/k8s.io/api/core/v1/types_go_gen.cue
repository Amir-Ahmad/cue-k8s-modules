...
import (
	...
	"github.com/amir-ahmad/cue-k8s-modules/k8s-schema/k8s.io/apimachinery/pkg/api/resource"
	"github.com/amir-ahmad/cue-k8s-modules/k8s-schema/k8s.io/apimachinery/pkg/util/intstr"
