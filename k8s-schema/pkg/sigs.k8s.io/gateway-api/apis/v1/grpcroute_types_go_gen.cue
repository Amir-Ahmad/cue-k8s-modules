...
import metav1 "github.com/amir-ahmad/cue-k8s-modules/k8s-schema/pkg/k8s.io/apimachinery/pkg/apis/meta/v1"
...
#GRPCRouteRule: {
	...
	filters?: [...#GRPCRouteFilter] @go(Filters,[]GRPCRouteFilter)
...
#GRPCRouteMatch: {
	...
	// +optional
	// +kubebuilder:validation:MaxItems=16
	headers?: [...#GRPCHeaderMatch] @go(Headers,[]GRPCHeaderMatch)
}
...
#GRPCMethodMatchType: string // #enumGRPCMethodMatchType

#enumGRPCMethodMatchType:
	#GRPCMethodMatchExact |
	#GRPCMethodMatchRegularExpression
...
//
// +kubebuilder:validation:Enum=Exact;RegularExpression
#GRPCHeaderMatchType: string // #enumGRPCHeaderMatchType

#enumGRPCHeaderMatchType:
	#GRPCHeaderMatchExact |
	#GRPCHeaderMatchRegularExpression

#GRPCHeaderMatchExact:             #GRPCHeaderMatchType & "Exact"
#GRPCHeaderMatchRegularExpression: #GRPCHeaderMatchType & "RegularExpression"

#GRPCHeaderName: #HeaderName

// GRPCRouteFilterType identifies a type of GRPCRoute filter.
#GRPCRouteFilterType: string // #enumGRPCRouteFilterType

#enumGRPCRouteFilterType:
	#GRPCRouteFilterRequestHeaderModifier |
	#GRPCRouteFilterResponseHeaderModifier |
	#GRPCRouteFilterRequestMirror |
	#GRPCRouteFilterExtensionRef
